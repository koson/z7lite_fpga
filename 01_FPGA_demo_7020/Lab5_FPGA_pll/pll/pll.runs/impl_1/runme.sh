...
HD_PWD='E:/demo/Z7-Lite/7020/FPGA/Lab5_FPGA_pll/pll/pll.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pll_led.tcl -notrace
