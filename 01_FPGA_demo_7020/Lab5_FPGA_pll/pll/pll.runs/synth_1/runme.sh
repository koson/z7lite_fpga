...
HD_PWD='E:/demo/Z7-Lite/7020/FPGA/Lab5_FPGA_pll/pll/pll.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll_led.tcl
