...
HD_PWD='E:/demo/Z7-Lite/7020/FPGA/Lab8_FPGA_LCD/led_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_shift.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_shift.tcl -notrace
