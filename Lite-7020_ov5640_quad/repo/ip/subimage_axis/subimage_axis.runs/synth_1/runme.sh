...
HD_PWD='D:/DualCam/course_s2/04_ov5640_single/repo/ip/subimage_axis/subimage_axis.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log subimage_axis.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source subimage_axis.tcl
